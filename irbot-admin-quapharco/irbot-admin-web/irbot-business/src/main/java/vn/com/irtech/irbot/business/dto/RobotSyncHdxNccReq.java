...
public class RobotSyncHdxNccReq implements Serializable {
	...
	private List<HdxNccDetailRes> processOrder;
	...
	public List<HdxNccDetailRes> getProcessOrder() {
		return processOrder;
	}

	public void setProcessOrder(List<HdxNccDetailRes> processOrder) {
