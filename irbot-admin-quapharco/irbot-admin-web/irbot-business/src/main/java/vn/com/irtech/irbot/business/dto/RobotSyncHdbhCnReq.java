...
public class RobotSyncHdbhCnReq implements Serializable {
	...
	private List<HdbhCnDetailRes> processOrder;
	...
	public List<HdbhCnDetailRes> getProcessOrder() {
		return processOrder;
	}

	public void setProcessOrder(List<HdbhCnDetailRes> processOrder) {
