...
public class RobotSyncHdbhReq implements Serializable {
	...
	private List<HdbhDetailRes> processOrder;
	...
	public List<HdbhDetailRes> getProcessOrder() {
		return processOrder;
	}

	public void setProcessOrder(List<HdbhDetailRes> processOrder) {
