...
public class HdbhMasterRes implements Serializable {
	...
	private List<HdbhDetailRes> details;
	...
	public List<HdbhDetailRes> getDetails() {
		return details;
	}

	public void setDetails(List<HdbhDetailRes> details) {
